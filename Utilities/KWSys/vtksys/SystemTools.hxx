...
#ifndef _SystemTools_hxx
#define _SystemTools_hxx
...
namespace  {
typedef _VA_LIST::hack_va_list va_list;
}
#endif // va_list
 ...
 */
class _EXPORT SystemToolsManager
{
public:
  SystemToolsManager();
  ~SystemToolsManager();
...
#if _SYSTEMTOOLS_USE_TRANSLATION_MAP
  /**
